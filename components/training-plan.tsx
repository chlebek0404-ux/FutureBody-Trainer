                    ...
                    <div className="grid lg:grid-cols-[150px_1fr]">
                      ...
                      <div className="p-5">
                        <div className="flex items-start gap-3">
                          <div className="min-w-0 flex-1"><p className="text-[9px] font-black uppercase tracking-wider text-black/30">{exercise.muscle} · {exercise.equipmentLabel}</p><h3 className="mt-1 text-lg font-black">{exercise.name}</h3></div>
